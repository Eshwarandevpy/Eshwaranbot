...
from Eshwaranbot import app, OWNER
from Eshwaranbot import app
from Eshwaranbot.config import OWNER_ID, BOT_NAME
from Eshwaranbot.database.chats import blacklist_chat, blacklisted_chats, whitelist_chat
from Eshwaranbot.utils.decorators import sudo_users_only
from Eshwaranbot.utils.filters import command
from Eshwaranbot.modules import check_heroku
from Eshwaranbot.utils.decorators import errors
from Eshwaranbot.database.functions import start_restart_stage
...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        os.execvp("python3", ["python3", "-m", "Eshwaranbot"])
    else:
        await message.reply_text("Eshwaranbot is already in the **up-to-date** mode**", disable_web_page_preview=True)
